...
const quickGradeService = require('../services/quickGradeService');
...
async function createQuickGrade(req, res, next) { try { res.status(201).json({ data: await quickGradeService.createQuickGrade(req.params.productId, req.body, req.user) }); } catch (error) { next(error); } }
...
module.exports = { assignImageVariant, createQuickGrade, createSkus, createVariant, get, updateSku, updateVariant };
